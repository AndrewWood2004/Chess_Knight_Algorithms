...
class AStar:
    ...
    def euclidian_distance(self, node1, node2):
    ...
    def calculate_heuristic_value(self, parent, child, target):
        return self.calculate_distance(parent, child) + self.euclidian_distance(child, target)
    ...
    def search(self):
        ...
        self.start.heuristic_value = self.euclidian_distance(self.start, self.target)
